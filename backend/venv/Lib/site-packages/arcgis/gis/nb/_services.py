...
class NBServicesManager:
    ...
    def properties(self) -> dict:
        ...
        .. code-block:: python
            ...
            # Usage Example:
            >>> properties = service_manager.properties
        """
        return PropertyMap(self._gis._con.get(self._url, {"f": "json"}))
    ...
    def create(self, item: Item, title: str, description: str = None) -> Item:
        ...
        **Parameter**           **Description**
        ...
        .. code-block:: python
            ...
            >>> notebook_item = gis.content.get("792a18985c2f4f15b8df0e1b545ea73f")

            >>> service_manager = gis.notebook_server[0].services
            >>> service_tool = service_manager.create(notebook_item, "nb_service", "this is a notebook service")

            >>> service_tool

            <Item title:"nb_service" type:Geoprocessing Toolbox owner:enterprise_admin>
