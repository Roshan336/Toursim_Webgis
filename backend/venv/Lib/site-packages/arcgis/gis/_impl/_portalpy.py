...
class Portal(object):
    ...
    def get_item_dependencies(self, itemid):
        ...
        while data["nextStart"] > 0:
            ...
            # update data to include correct nextStart and total num
    ...
    def update_item(
        ...
        **Parameter**           **Description**
        ...
        # Clear tags if being passed as None or empty string or empty list
        if "tags" in postdata and (
            postdata["tags"] is None or postdata["tags"] == "" or postdata["tags"] == []
        ):
            # Need to state clear empty fields to clear tags
            postdata["clearEmptyFields"] = True
        # Setup the item path, including the folder, and post to it
        path = "content/users/" + owner
        if folder:
