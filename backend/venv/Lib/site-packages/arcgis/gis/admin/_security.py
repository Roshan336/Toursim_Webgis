...
class SSLCertificates(BasePortalAdmin):
    ...
    # ----------------------------------------------------------------------
    def import_server_certificate(
        self,
        alias: str,
        password: str,
        certificate: str,
        import_chain: bool | None = None,
    ) -> dict:
        """
        ...
        **Parameter**                    **Description**
        ...
        certificate                     Required string. The file location of the certificate file
        ---------------------------     --------------------------------------------------------------------
        import_chain                    Optional Bool. Introduced in 11.3. Specifies if the root or
                                        intermediate certificates included inside the existing certificate
                                        file should also be imported. By default, the parameter is set to
                                        true.
        ===========================     ====================================================================
        ...
        files = {"file": certificate}
        if isinstance(import_chain, bool):
            params["importCertificateChain"] = import_chain
