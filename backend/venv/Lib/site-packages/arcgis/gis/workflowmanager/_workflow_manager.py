...
from ._workflow_manager_client import WorkflowManagerClient
...
def _check_license(gis):
    client = WorkflowManagerClient(gis)
    ...
    if is_portal and portal_version < 10.3:  # < ArcGIS Enterprise 11.1
        ...
        raw_user = client.get(user_url, {"returnUserLicenseTypeExtensions": True})
...
def _initialize(instance, gis, is_admin=False):
    ...
    instance._client = WorkflowManagerClient(gis)
    ...
    for _url in [public_url, private_url]:
        try:
            if _url:
                ...
                client.get(f"{_url}/workflow/checkStatus")
                return _url
        except:
    ...
    **Parameter**        **Description**
    ...
    def create_item(self, name: str) -> tuple:
        ...
        **Parameter**        **Description**
        ...
        params = {"name": name}
        return_obj = json.loads(self._client.post(url, params=params))
        return_obj = return_obj["itemId"]
        if "error" in return_obj:
            self._client.handle_json_error(return_obj["error"])
    ...
    def upgrade_item(self, item):  # TODO TypeHint removed in order to avoid import
        ...
        **Parameter**        **Description**
        ...
        return_obj = json.loads(self._client.post(url))
        if "error" in return_obj:
            self._client.handle_json_error(return_obj["error"])
        elif "success" in return_obj:
            return return_obj["success"]
    ...
    def delete_item(self, item):  # TODO TypeHint removed in order to avoid import
        ...
        **Parameter**        **Description**
        ...
        return_obj = json.loads(self._client.delete(url))
        if "error" in return_obj:
            self._client.handle_json_error(return_obj["error"])
        elif "success" in return_obj:
            return return_obj["success"]
    ...
    def server_status(self):
        ...
        return_obj = self._client.get(url)
        if "error" in return_obj:
            self._client.handle_json_error(return_obj["error"])
        elif "success" in return_obj:
            return return_obj["success"]
    ...
    def _retrieve_completed_export(
        ...
        return_obj = self._client.get(url, out_folder=save_path)
    ...
    def import_item(
        ...
        **Argument**             **Description**
        ...
        def call_post(url, files, data):
            return_obj = self._client.post_multipart(
                url,
                files=files,
                params=data,
            )
    ...
    **Parameter**        **Description**
    ...
    def evaluate_arcade(
        ...
        **Parameter**            **Description**
        ...
        res = self._client.post(url, params=params, try_json=True)
    ...
    def settings(self):
        ...
        """
        try:
            return self._client.get("{base}/settings".format(base=self._url))[
                "settings"
            ]
        except:
            self._handle_error(sys.exc_info())
    ...
    def job_templates(self):
        ...
        """
        try:
            template_array = self._client.get(
    ...
    def diagrams(self):
        ...
        """
        try:
            diagram_array = self._client.get("{base}/diagrams".format(base=self._url))[
                "diagrams"
            ]
    ...
    def create_job_template(
        ...
        default_final_status: str | None = None,
    ):
        """
        ...
        **Parameter**                             **Description**
        ...
        ------------------------------------     --------------------------------------------------------------------
        default_job_name                         Optional string. Define the default job name on a job template. If null, it is set to JOB_[index].
        ------------------------------------     --------------------------------------------------------------------
        default_status                           Optional string. Define the initial job status on a job template.
        ------------------------------------     --------------------------------------------------------------------
        default_final_status                     Optional string. Define the final job status on a job template.
        ====================================     ====================================================================
            ...
            post_job_template = JobTemplate(
                {
                    ...
                    "defaultJobName": default_job_name,
                    "defaultStatus": default_status,
                    "defaultFinalStatus": default_final_status,
                }
            )
    ...
    def templates(self, template_type):
        ...
        **Parameter**        **Description**
        ...
        """
        try:
            template_list = self._client.get(f"{self._url}/templates/{template_type}")[
                "templates"
            ]
    ...
    def get_template(self, template_type: str, template_id: str):
        ...
        **Parameter**        **Description**
        ...
        try:
            ...
            template_dict = self._client.get(url, {})
            return Template(
...
class LookUpTable(object):
    ...
    **Parameter**        **Description**
    ...
    def __init__(self, init_data, gis=None, url=None):
        ...
        self._gis = gis
        self._url = url
        self._client = WorkflowManagerClient(gis) if gis else None
    ...
    def get(self, gis, url, params):
        client = WorkflowManagerClient(gis)
        lookup_dict = client.get(url, params)
    ...
    def put(self, gis, url):
        ...
        if "error" in return_obj:
            client.handle_json_error(return_obj["error"])
        elif "success" in return_obj:
            return return_obj["success"]
        return_obj = {
            _camelCase_to_underscore(k): v
    ...
    def delete(self, gis, url):
        client = WorkflowManagerClient(gis)
        return_obj = json.loads(client.delete(url))
        if "error" in return_obj:
            client.handle_json_error(return_obj["error"])
        elif "success" in return_obj:
            return return_obj["success"]
...
class Template(object):
    ...
    **Parameter**          **Description**
    ...
    def __getattr__(self, item):
        gis = object.__getattribute__(self, "_gis")
        url = object.__getattribute__(self, "_url")
        full_object = self._client.get(url, {})
        try:
            setattr(self, _camelCase_to_underscore(item), full_object[item])
            return full_object[item]
        except KeyError:
...
class Job(object):
    ...
    def __init__(self, init_data, gis=None, url=None, workflow_manager=None):
        ...
        self._url = url
        self._workflow_manager = workflow_manager
        self._client = WorkflowManagerClient(gis)
    ...
    def update_attachment(self, attachment_id: str, alias: str):
        ...
        **Parameter**        **Description**
        ...
        return_obj = json.loads(
            self._client.post(url, post_json=False, params=post_object)
        )
        if "error" in return_obj:
            self._client.handle_json_error(return_obj["error"])
        elif "success" in return_obj:
...
class WMRole(object):
    ...
    **Parameter**        **Description**
    ...
    def get(self, gis, url, params):
        client = WorkflowManagerClient(gis)
        role_dict = client.get(url, params)
...
class JobTemplate(object):
    ...
    **Parameter**        **Description**
    ...
    def get(self, gis, url, params):
        client = WorkflowManagerClient(gis)
        job_template_dict = client.get(url, params)
    ...
    def share(self, group_ids):
        ...
        **Parameter**        **Description**
        ...
        try:
            ...
            return_obj = json.loads(self._client.post(url, post_dict))
...
class Group(object):
    ...
    **Parameter**        **Description**
    ...
    def get(self, gis, url, params):
        client = WorkflowManagerClient(gis)
        group_dict = client.get(url, params)
...
class JobDiagram(object):
    ...
    def get(self, gis, url, params):
        client = WorkflowManagerClient(gis)
        job_diagram_dict = client.get(url, params)
...
class JobLocation(object):
    ...
    **Parameter**        **Description**
    ...
    def get(self, gis, url, params):
        client = WorkflowManagerClient(gis)
        job_location_dict = client.get(url, params)
