...
class SingleShotDetector(ArcGISModel):
    ...
    **Parameter**            **Description**
    ...
    backbone                Optional string. Backbone convolutional neural network
                            ...
                            Supported backbones: ResNet, DenseNet, VGG, ViT families
    ...
    **Parameter**            **Description**
    ...
    def _freeze(self):
        if isinstance(self.learn.model[0][0].backbone, ViT):
            pretrained_layers, random_layers = self.learn.model[0][0].backbone._freeze()
            random_layers.extend(flatten_model(self.learn.model[1]))
            ...
            idx = len(layers)
            if "terramind" in self._backbone.__name__:
                self.learn.model[0][0].backbone._freeze_backone()
                self.learn.model[0][0].backbone._is_vitdet = True
            else:
                start_idx = 0
