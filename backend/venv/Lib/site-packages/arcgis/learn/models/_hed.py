...
class HEDEdgeDetector(ModelExtension):
    ...
    **Parameter**            **Description**
    ...
    backbone                Optional string. Backbone convolutional neural network
                            ...
                            default.
                            Supported backbones: ResNet, Vgg, ViT families and specified Timm
    ...
    def _freeze(self):
        ...
        if self._backbone.__name__ in list(vit_config.keys()):
            if "terramind" in self._backbone.__name__:
                self.learn.model.backbone.backbone_fpn.backbone._freeze_backone()
                self.learn.model.backbone.backbone_fpn._is_vitdet = True
            else:
