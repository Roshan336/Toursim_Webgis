...
class DeepLab(ArcGISModel):
    ...
    **Parameter**            **Description**
    ...
    backbone                Optional string. Backbone convolutional neural network
                            ...
                            torchvision.
                            Supported backbones: ResNet, DenseNet, VGG , ViT families and
    ...
    def _freeze(self):
        ...
        if self._backbone.__name__ in DeepLab.transformer_backbones():
            if "terramind" in self._backbone.__name__:
                self.learn.model.backbone[0].backbone._freeze_backone()
    ...
    def per_class_metrics(self, ignore_classes=[]):
        ...
        **Parameter**            **Description**
        ...
        try:
            ...
            return pd.read_json(io.StringIO(self._data.emd["per_class_metrics"]))
