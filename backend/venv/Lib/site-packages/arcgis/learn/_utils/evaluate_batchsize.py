...
exception_backbone_models = ["SuperResolution", "Pix2Pix"]
exception_models = [
            ...
            try:
                if mode == "train":
                    ...
                    if "model" in model._model_kwargs:
                        ...
                        if model.__class__.__name__ in exception_backbone_models:
                            nonemodel = getattr(ag.learn, model.__class__.__name__)(
                                model._data, backbone=model._backbone.__name__
                            )
                        else:
                            nonemodel = getattr(ag.learn, model.__class__.__name__)(
