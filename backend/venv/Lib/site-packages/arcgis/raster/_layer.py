...
class ImageryLayerCacheManager(_GISResource):
    ...
    def edit_tile_service(
        ...
        **Parameter**              **Description**
        ...
        ---------------------     ----------------------------------------------------
        source_item_id            Optional String. The *item id* of the source map
                                  service.
        ---------------------     ----------------------------------------------------
    ...
    context                                  Optional. Additional properties to control the creation of RasterCollection.
                                             ...
                                             Currently available:
                                                 ...
                                                 -  query_boundary:
                                                    ...
                                                    By default, query_boundary is set to False, i.e, SHAPE field will not be added.
...
class _ImageServerRasterCollection(ImageryLayer, RasterCollection):
    ...
    def _as_df(
        ...
        if result_record_count is None:
            result_record_count = self._max_rec_count
