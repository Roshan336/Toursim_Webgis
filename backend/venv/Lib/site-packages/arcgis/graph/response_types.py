...
class DataTransferStats(BaseModel):
    type_name: str = Field(
        ..., description="The name of the entity or relationship type."
    )

    source_count: int = Field(..., description="The number of this type in the graph.")
    transferred_count: int = Field(
        ..., description="The number of this type transferred."
    )


class ExportResponse(BaseModel):

    submission_time: int = Field(
        ..., description="The time the export job was submitted."
    )

    completion_time: int = Field(
        ..., description="The time the export job was completed."
    )
    ...
    warnings: Optional[list[Error]] = Field(
        default=None, description="The warnings generated during the export job."
    )

    service_definition_name: str = Field(
        ..., description="The name of the service definition created by the export job."
    )

    export_data_format: str = Field(..., description="The format of the exported data.")

    download_url: str = Field(..., description="The URL to download the exported data.")

    statistics: list[DataTransferStats] = Field(
        ..., description="The statistics generated during the export job."
    )
...
class AddDomainResponse(DomainResponse):
    pass


class UpdateDomainResponse(DomainResponse):
    pass


class DeleteDomainResponse(DomainResponse):
    pass
