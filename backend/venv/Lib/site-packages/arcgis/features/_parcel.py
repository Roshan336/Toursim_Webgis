    ...
    **Parameter**             **Description**
    ...
    def properties(self):
        ...
        if self._properties is None:
            res = self._session.get(self._url, params={"f": "json"}).json()
    ...
    def _validate_extent(self, extent: dict | Envelope):
        ...
        if isinstance(extent, (dict, Envelope)):
            ...
            raise Exception("Could not validate the extent.")
    ...
    def shrink_to_seed(
        ...
        **Parameter**                **Description**
        ...
        params = {
            "gdbVersion": self._version.properties.versionName,
            "sessionId": self._version._guid,
            "parcelFeatures": json.dumps(parcel_features),
            "async": future,
            "f": "json",
        }
