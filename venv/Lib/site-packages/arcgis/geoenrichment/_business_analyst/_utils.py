...
def get_helper_service_url(gis: GIS, service_key: str) -> str:
    ...
    if (
        isinstance(gis, GIS)
        and hasattr(gis, "_use_private_url_only")
        and gis._use_private_url_only
    ):
...
def get_network_dataset_path_local(properties) -> str:
...
def set_local_ba_analysis_source(properties) -> None:
