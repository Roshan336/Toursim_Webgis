...
class StoryMap(object):
    ...
    **Parameter**        **Description**
    ...
    @deprecated(
        deprecated_in="2.4.2",
        removed_in="3.0.0",
        details="Use contents property instead.",
    )
    ...
    def delete_story(self, permanent: bool = False) -> bool:
        """
        ...
        **Parameter**        **Description**
        ---------------     --------------------------------------------------------------------
        permanent           Optional boolean. If True, the story is permanently deleted and cannot
                            be recovered from the portal's recycle bin. Default is False, which means
                            the story can be recovered from the recycle bin if deleted.
        ===============     ====================================================================
        """
        # Check if item id exists
        # deletes the item
        return utils.delete_item(self, permanent)
