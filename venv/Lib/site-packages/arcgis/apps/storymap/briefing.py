...
class Briefing(object):
    ...
    **Parameter**        **Description**
    ...
    def _create_new_briefing(self) -> None:
        ...
        briefing_node = self._generate_unique_node_id()
    ...
    def add(
        ...
        slide: story_content.BriefingSlide | None = None,
        *,
        ...
        **Parameter**           **Description**
        ...
        """
        if not slide:
            slide = story_content.BriefingSlide(
                layout=layout,
                sublayout=sublayout,
                title=title,
                subtitle=subtitle,
        ...
        utils.add_child(self, node_id=slide._node, position=position)
    ...
    # ----------------------------------------------------------------------
    def delete_briefing(self, permanent: bool = False) -> bool:
        """
        ...
        """
        # deletes the item
        return utils.delete_item(self, permanent=permanent)
    ...
    def copy_content(self, target_briefing: Briefing, content: list) -> bool:
        ...
        **Parameter**        **Description**
        ...
        target_briefing     Required Briefing instance. The target briefing that the content will be
                            copied to.
        ---------------     --------------------------------------------------------------------
        content             Required list of content. The list of slides that will be copied to
                            the target briefing.
        ===============     ====================================================================
