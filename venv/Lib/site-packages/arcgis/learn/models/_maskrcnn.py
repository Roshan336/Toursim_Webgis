    ...
    **Parameter**                    **Description**
    ...
    def __init__(
        ...
        **kwargs,
        ...
        is_timm_legacy = getattr(self._backbone, "__is_timm_legacy__", False)
        ...
        try:
            if (
                ...
                if "timm" in self._backbone.__module__ or is_timm_legacy:
                    model.rpn.anchor_generator.grid_anchors = types.MethodType(
                        grid_anchors, model.rpn.anchor_generator
                    )
    ...
    def _freeze(self):
        ...
        if "terramind" in self._backbone.__name__:
            ...
            self.learn.model.backbone.backbone._is_vitdet = True
        else:
            start_idx = 0
            if self._is_multispectral:
                start_idx = 1
