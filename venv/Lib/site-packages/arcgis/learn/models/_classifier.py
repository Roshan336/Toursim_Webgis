    ...
    def _freeze(self):
        ...
        if self._backbone.__name__ in FeatureClassifier.foundation_model_backbones():
            if "terramind" in self._backbone.__name__:
                self.learn.model[0].freeze_backbone()
                self.learn.model[0]._is_vitdet = True
            else:
