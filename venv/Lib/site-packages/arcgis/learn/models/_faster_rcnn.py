    ...
    **Parameter**                    **Description**
    ...
    def _freeze(self):
        ...
        if isinstance(backbone, ViT):
            ...
            random_layers.extend(flatten_model(self.learn.model.rpn))
            random_layers.extend(flatten_model(self.learn.model.roi_heads))
            ...
            if "terramind" in self._backbone.__name__:
                self.learn.model.backbone.backbone._freeze_backone()
                self.learn.model.backbone._is_vitdet = True
            else:
                start_idx = 0
