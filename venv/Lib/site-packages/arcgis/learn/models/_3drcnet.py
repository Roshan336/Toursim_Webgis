...
class Hyperspectral3DRCNet(ArcGISModel):
    ...
    **Parameter**            **Description**
    ...
    def __init__(self, data, pretrained_path=None, *args, **kwargs):
        ...
        self.kwargs = kwargs
        if not isinstance(data, _EmptyData) or isinstance(data, ImageDataBunch):
    ...
    def _get_emd_params(self, save_inference_file):
        ...
        _emd_template["ImageHeight"] = self._data.chipsize_height
        _emd_template["ImageWidth"] = self._data.chipsize_width
