...
class TokenPrivilege(Enum):
    USE_AI_ASSISTANTS = "portal:user:useAIAssistants"  # Grants the ability to use generative AI and ArcGIS assistants. This privilege is available only if the organization allows the use of AI assistants.
...
class DeveloperCredentialManager:
    """
    A class to manage Developer Credentials for a user's GIS.
    """
    ...
    def create(
        ...
        """
        Creates API Key Credentials on a given GIS.
        ...
        **Parameter**      **Description**
        ...
        ----------------  ---------------------------------------------------------------
        expiration        Required datetime.datetime. The date the developer credentials
        ...
        .. code-block:: python
            ...
            gis_user = GIS(profile="your_online_admin_profile")

            # Initializing the DeveloperCredentialManager object
            developer_credential_manager = gis_user.admin.developer_credentials

            # Create the API Key Credentials
            api_key_credentials = developer_credential_manager.create(title = "test_api_key_credentials_2",
                        privileges = [TokenPrivilege.PORTAL_USER_VIEWORGUSERS],
                        expiration=datetime.datetime(2026, 3, 8, 11, 29, 22, 266123),
