...
class PortalDataStore(object):
    ...
    def publish(
        ...
        *,
        ...
        """
        Publishes services by reference from specific datasets in the
        `data store item :class:<arcgis.gis.Item>`.

        .. note::
            This **only** supports publishing of data store items.
        ...
        **Parameter**           **Description**
        ...
        config                 Required Dictionary.  This is the service configuration property
                               ...
                               specifies the data store *item* Id and the path of the data within it.
                               A client can discover the proper paths of the data by using the
                               :meth:`~PortalDataStore.describe` method on the *data store item*.
                               ...
                               .. code-block:: python
                                   ...
                                   # Example format for parameter argument

                                   gis.datastore.publish(
                                       config = {
                                           "type":"SceneServer",
                                           "serviceName":"sonoma",
                                           "properties":{
        ...
        ------------------     --------------------------------------------------------------------
        server_id              Required String. The unique id value for the server to publish to.
        ...
        ------------------     --------------------------------------------------------------------
        description            Optional String. An optional string to attach to the generated
        ...
        ------------------     --------------------------------------------------------------------
        options                New at *2.4.3* release. Optional dict. An optional publishing
                               configuration as a dictionary.
        ------------------     --------------------------------------------------------------------
        overwrite              New at *2.4.3* release. Option bool.  Indicates whether operation
                               will overwrite the *style* used for the vector tiles that published
                               the *MapService*.

                               * *True* - overwrite the current style with the new style provided
                                 in the *service_config* argument
                               * *False* - the *Default*. Do not overwrite the current style.
        ==================     ====================================================================
        ...
        if options:
            params["pubOptions"] = json.dumps(options)
        if overwrite:
