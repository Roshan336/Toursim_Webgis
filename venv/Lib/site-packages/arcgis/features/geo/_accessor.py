...
class GeoAccessor(object):
    ...
    def name(self):
        ...
        if self._name is None:
            try:
                ...
                raise Exception(
                    f"Spatial column not defined, please use `set_geometry` Exception: {ex}"
                )
        return self._name
    ...
    def join(
        ...
        **Parameter**              **Description**
        ...
        shape_right = right_df.spatial.name
                ...
                np.column_stack(
                    [
                        ...
                        check_predicates(
                            ...
                            right_df[right_df.spatial.name][r_idx],
                        ),
                    ]
                )
            )
    ...
    def __feature_set__(self):
        ...
        _look_up = {
            ...
            pd.StringDtype(na_value=nan): "esriFieldTypeString",
