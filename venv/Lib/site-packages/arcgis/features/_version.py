...
class Version(object):
    ...
    **Parameter**        **Description**
    ...
    def stop_editing(self, save: Optional[bool] = None):
        """
        Stops an edit session for the current user.
    ...
    def partial_post(
        ...
        """
        The `partialPost` operation allows the client to post a subset of edits to the `DEFAULT` version. The rows parameter supports
        features or objects from simple classes, tables, relationships, utility network classes and topology classes.
        ...
        **Parameter**           **Description**
        -------------------     --------------------------------------------------------------------
            rows                Required List of dictionaries representing the features or objects
                                for posting a subset of edits in the current version. The
                                `objectIds` specified must be edits contained within the current
                                version, which can be obtained from the
                                :meth:`~arcgis.features._version.Version.differences` method. The
        ...
        :return:
            Dictionary indicating success or failure and if conflicts were detected.
